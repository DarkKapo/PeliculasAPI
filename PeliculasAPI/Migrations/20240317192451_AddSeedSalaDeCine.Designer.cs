...
namespace PeliculasAPI.Migrations
{
    ...
    [Migration("20240317192451_AddSeedSalaDeCine")]
    partial class AddSeedSalaDeCine
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.Genero", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.Pelicula", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.PeliculasActores", b =>
                {
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.PeliculasGeneros", b =>
                {
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.PeliculasSalasDeCine", b =>
                {
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.SalaDeCine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Nombre = "Vespucio",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-33.51554 -70.58515)")
                        },
                        new
                        {
                            Id = 6,
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.PeliculasActores", b =>
                {
                    b.HasOne("PeliculasAPI.Controllers.Entidades.Actor", "Actor")
                        .WithMany("PeliculasActores")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeliculasAPI.Controllers.Entidades.Pelicula", "Pelicula")
                        .WithMany("PeliculasActores")
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.PeliculasGeneros", b =>
                {
                    b.HasOne("PeliculasAPI.Controllers.Entidades.Genero", "Genero")
            ...
            modelBuilder.Entity("PeliculasAPI.Controllers.Entidades.PeliculasSalasDeCine", b =>
                {
                    ...
                    b.HasOne("PeliculasAPI.Controllers.Entidades.SalaDeCine", "SalaDeCine")
                        .WithMany("PeliculasSalasDeCine")
